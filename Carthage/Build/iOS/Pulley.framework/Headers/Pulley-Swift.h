...
#ifndef PULLEY_SWIFT_H
#define PULLEY_SWIFT_H
...
@property (nonatomic) IBInspectable CGFloat drawerTopInset;
...
@property (nonatomic) IBInspectable UIEdgeInsets panelInsets;
/// The width of the panel in panel displayMode
@property (nonatomic) IBInspectable CGFloat panelWidth;
...
@property (nonatomic) IBInspectable CGFloat drawerCornerRadius;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull backgroundDimmingColor;
/// The maximum amount of opacity when dimming.
@property (nonatomic) IBInspectable CGFloat backgroundDimmingOpacity;
/// The drawer scrollview’s delaysContentTouches setting
@property (nonatomic) IBInspectable BOOL delaysContentTouches;
/// The drawer scrollview’s canCancelContentTouches setting
@property (nonatomic) IBInspectable BOOL canCancelContentTouches;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable initialDrawerPositionFromIB;
...
@property (nonatomic) IBInspectable BOOL allowsUserDrawerPositionChange;
...
@property (nonatomic) IBInspectable NSTimeInterval animationDelay;
...
@property (nonatomic) IBInspectable CGFloat animationSpringInitialVelocity;
...
@property (nonatomic) IBInspectable BOOL adjustDrawerHorizontalInsetToSafeArea;
