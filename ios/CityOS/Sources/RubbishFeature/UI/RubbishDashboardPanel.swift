        ...
        CardPanelView {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                viewModel.state.hasResource { (items) in
                    ...
                    HStack {
                        Text("Next collection dates", bundle: .module)
                            .font(.title3)
                            .fontWeight(.semibold)
                        Spacer()
                    }
    ...
    private func loading() -> some View {
        ...
        HStack {
            ...
            VStack(spacing: 12) {
                ...
                Text("Loading waste schedule…", bundle: .module)
                    .fontWeight(.semibold)
                    .font(.callout)
            }
            Spacer()
        ...
        VStack {
            HStack(spacing: 12) {
                Image(systemName: "calendar.badge.exclamationmark")
                    .font(.largeTitle)
                Text("No further dates could be found in the waste calendar.", bundle: .module)
                    .multilineTextAlignment(.leading)
                    .frame(maxWidth: .infinity, alignment: .leading)
            }
        }
