    ...
    private func applySnapshot() {
        ...
        case .overview(let favouriteEvents, let activeEvents, let upcomingEvents):
            ...
            if upcomingEvents.isEmpty {
                snapshot.appendItems(
                    [.hint(String(localized: "Currently there are no events scheduled. Come back soon!", bundle: .module))],
                    toSection: .upcoming
                )
            } else {
        ...
        case .list(let keyedEvents):
            if keyedEvents.isEmpty {
                ...
                snapshot.appendItems(
                    [.hint(
                        String(localized: "Currently there are no events scheduled. Come back soon!", bundle: .module)
                    )],
                    toSection: .dated("")
                )
            } else {
