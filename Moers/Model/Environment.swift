...
struct Environment {
    ...
    static var all: [Environment.EnvironmentType: Environment] = [.production: Environment(name: "Production", baseURL: "https://meinmoers.lambdadigamma.com/", clientID: 2, clientSecret: "", type: .production),
