...
class RebuildBranchTableViewCell: UITableViewCell {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(RebuildBranchCollectionViewCell.self, forCellWithReuseIdentifier: "branchCell")
...
extension RebuildBranchTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "branchCell", for: indexPath) as! RebuildBranchCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        guard let branchCell = cell as? RebuildBranchCollectionViewCell else { return }
