...
public struct TrackingPoint: Codable {
    ...
    public var gatewayAltitude: Int
    public var gatewayID: String
    public var gatewayLatitude: Double
    public var gatewayLongitude: Double
    public var gatewayRSSI: Int
    ...
    public static func randomInMoers() -> TrackingPoint {
